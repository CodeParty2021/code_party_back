...
class StageAPITests(TestCase):
    def setUp(self):  # テストケース実行毎に実行される
        ...
        #データ準備
        self.client.post('/stageapi/stages/', {'name': 'Stage1', 'stage_index': 10, 'rule': 'This is rules of stage1.'}, format='json')
        self.client.post('/stageapi/stages/', {'name': 'ステージ２', 'stage_index': 1, 'rule': 'ステージ２のルールです．'}, format='json')
